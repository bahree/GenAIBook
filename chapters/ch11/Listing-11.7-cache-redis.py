...
input_questions = ["What is the capital of UK?", "What is the capital of France?", "What's the square root of 144?", "What is the capital of WA state?", "What is the capital of USA?", "What is the capital of Canada?", "What is the capital of Australia?", "What is the capital of India?", "What is the capital of China?", "What is the capital of Japan?"]
...
#     question = random.choice(input_questions)
...
#     print(f"Without caching, LLM call took {end_time-start_time} seconds.")
...
#     print(f"Percentage of time saved: {round(((end_time - start_time) - avg_time_with_cache) / (end_time - start_time) * 100, 2)}%")
